...
public class Path {
    ...
    public static final String getxPathForLoginTest1="/html/body/ion-app/ion-alert/div/div[3]/button[2]/span";
    public static final String getxPathForLoginTest=".//span[@class='button-inner']";
    public static final String xPathForDeviceRegErrormsg1="/html/body/ion-app/ng-component/ion-nav/page-home/ion-content/div[2]/ion-grid/ion-row/ion-col[1]";
    public static final String xPathForDeviceRegErrormsg3="//*[@id='alert-subhdr-4']";
    public static final String xPathForDeviceRegSuccessmsg="/html/body/ion-app/ion-alert/div/div[1]";
    public static final String xPathForDeviceRegSuccessmsgOkButtonClick="/html/body/ion-app/ion-alert/div/div[3]/button";
    ...
    public static final String xPathForDeviceRegYes1="//*[@id='rb-45-0']";
